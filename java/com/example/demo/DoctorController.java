...
public class DoctorController {
	...
	public String addProduct(@RequestParam ("dietFile") MultipartFile myFile,
		...
		try {
			Doctor prdImage = new Doctor(name,degree,spl,exp,address,phone,
	...
	public List<Doctor> deleteDoctor(@RequestParam int id){
	...
	public List<Doctor> getAllProducts(){
		...
		List<Doctor> resDrList = doctorRepo.findAll();
		Doctor doctor = null;
